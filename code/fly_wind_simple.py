...
class FlyWindSimpleCal:
    ...
    def set_output_mode(self, output_mode, angular_outputs=None):
        self.output_mode = output_mode
        self.angular_outputs = angular_outputs
    ...
    def get_outputs(self, output_mode=None):
        ...
        self.p = len(output_names)

        n_point = len(self.sim_data['time'])
        y = np.nan * np.zeros((n_point, self.p))
